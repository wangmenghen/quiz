...
@section('content')
    ...
    <p>
        <a href="/create_judge_questions" class="btn btn-success">@lang('quickadmin.add_new')</a>
    </p>
                    ...
                    @if (count($questions) > 0)
                        @foreach ($questions as $question)
                            <tr data-entry-id="{{ $question->id }}">
                                ...
                                @endif
                                <td>
                                    <a href="/show_judge_questions/{{$question->id}}" class="btn btn-xs btn-primary">@lang('quickadmin.view')</a>
                                    <a href="/edit_judge_questions/{{$question->id}}" class="btn btn-xs btn-info">@lang('quickadmin.edit')</a>
                                    {!! Form::open(array(
